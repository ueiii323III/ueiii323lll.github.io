...
Page({
    ...
    loadSettings() {
        const settings = storage_1.StorageHelper.getReminderSettings();
        this.setData({
    ...
    saveSettings() {
        ...
        storage_1.StorageHelper.saveReminderSettings(settings);
        // 重新设置提醒
    ...
    // 调度单个提醒
    scheduleReminder(type, time, content) {
